 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Rg(n){yf(Mt),J(new K("database",(e,{instanceIdentifier:t})=>{const i=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return wg(i,s,r,t)},"PUBLIC").setMultipleInstances(!0)),$(ur,hr,n),$(ur,hr,"esm2017")}ce.prototype.simpleListen=function(n,e){this.sendRequest("q",{p:n},e)};ce.prototype.echo=function(n,e){this.sendRequest("echo",{d:n},e)};Rg();const kg={apiKey:"AIzaSyCnEVCHDsE29Sryy8dUu5YhZMcchOWuJ-4",authDomain:"opaku-1b923.firebaseapp.com",projectId:"opaku-1b923",storageBucket:"opaku-1b923.appspot.com",messagingSenderId:"257332122135",appId:"1:257332122135:web:bb4acdb522cea5da53c252",measurementId:"G-Z53H78Q4JV",databaseURL:"https://opaku-1b923-default-rtdb.asia-southeast1.firebasedatabase.app/"},bl=oo(kg),Bg=Jh(bl),Vg=new re,Hg=Tg(bl);export{re as G,Bg as a,Og as b,bl as c,Hg as d,mg as e,Lg as f,Fg as g,Ug as h,Wg as i,xg as j,Pg as k,gf as l,Dg as m,Vg as n,Ng as o,Mg as r,Ag as s};
